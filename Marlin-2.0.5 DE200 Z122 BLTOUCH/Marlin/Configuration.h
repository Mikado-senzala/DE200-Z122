...
#define STRING_CONFIG_H_AUTHOR "Mikado Z122 DE200" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "DE200 Z122 2.0.5.3"
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -57, -1.70 }
...
#define Y_MAX_POS 244.9 // Mikado pour centrage du plateau
